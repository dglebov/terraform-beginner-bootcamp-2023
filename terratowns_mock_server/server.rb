...
# be setting a global variable. You would never use a global variable 
# in a real workld application
$home = {}


# This is a ruby class that includes validation from ActiveRecord.
# This will represent our Home resoures as a ruby object 
class Home
  # ActiveModel is part of Ruby on Rails.
  # it is used as a ORM. It has a module within
  # ActiveModel that provides validation 
  # The production Terratowns server is rails and uses very similar and in most cases identical validations 
